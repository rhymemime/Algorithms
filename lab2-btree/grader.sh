...
dcs=/home/jplank/cs494/labs/Lab-2-B-Tree/bin/b_tree_dcs
namefile=/home/jplank/cs494/labs/Lab-2-B-Tree/names.txt
...
if [ $mod = 1 ]; then
  ...
  /home/jplank/cs494/labs/Lab-2-B-Tree/bin/b_tree_test tree-answer.jdisk CREATE 51200 $ks < input.txt > /dev/null
...
./bin/b_tree_test tree-$USER.jdisk CREATE 51200 $ks < input.txt > /dev/null"
  ...
  rm -f tree-$USER.jdisk tree-answer.jdisk
  $randnum $1 < $namefile | sort -n | awk '{ print "I", $2, $3 }' | head -n $nentries > input.txt
  head -n $nentries1 input.txt | /home/jplank/cs494/labs/Lab-2-B-Tree/bin/b_tree_test tree-answer.jdisk CREATE 614400 $ks > /dev/null
  cp tree-answer.jdisk tree-$USER.jdisk
  sed  1,"$nentries1"d input.txt | /home/jplank/cs494/labs/Lab-2-B-Tree/bin/b_tree_test tree-answer.jdisk > /dev/null
...
sed  1,$nentries1""d input.txt | ./bin/b_tree_test tree-$USER.jdisk > /dev/null"
  ...
  rm -f tree-$USER.jdisk tree-answer.jdisk
  /home/jplank/cs494/labs/Lab-2-B-Tree/bin/random_tester_1 $1 $nentries $ks $vs tree-answer.jdisk - - > /dev/null
...
./bin/random_tester_1 $1 $nentries $ks $vs tree-$USER.jdisk - - > /dev/null"
  ...
  ks=`echo $n | awk '{ printf "%d\n", ($2 * 238) + 15 }'`
  rm -f tree-$USER.jdisk tree-answer.jdisk
  /home/jplank/cs494/labs/Lab-2-B-Tree/bin/random_tester_2 $1 $nentries $ks tree-answer.jdisk - - > /dev/null
...
./bin/random_tester_2 $1 $nentries $ks tree-$USER.jdisk - - > /dev/null"
  ...
  ks=254
  rm -f tree-$USER.jdisk tree-answer.jdisk
  /home/jplank/cs494/labs/Lab-2-B-Tree/bin/b_tree_test tree-answer.jdisk CREATE $tsize $ks < /dev/null > /dev/null
  /home/jplank/cs494/labs/Lab-2-B-Tree/bin/random_tester_2 $1 $nentries1 $ks tree-answer.jdisk - input.txt > /dev/null
  cp tree-answer.jdisk tree-$USER.jdisk
  /home/jplank/cs494/labs/Lab-2-B-Tree/bin/random_tester_2 $seed2 $nentries2 $ks tree-answer.jdisk input.txt - > /dev/null
